...
def calculate_recipients
  ...
  still_sub = (SUBSCRIBERS - UNSUBSCRIBED).push
binding.pry

return still_sub
      
    #loyal_sub = SUBSCRIBERS.slice(rvmed)
...
def print_one_article(article)
  ...
  #I'm not sure how this works or whether it's right
...
arr = []
articles.each do |one_thing|
    new_hash = print_one_article
#need help with understanding this. I know it calls the method above but I also don't understand
#what is being asked for the method above
#hence don't understand this one as well. please help 
  end
